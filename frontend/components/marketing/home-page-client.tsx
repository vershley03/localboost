    ...
    <>
      ...
      <nav className="navbar">
        ...
        <div className="navbar-cta">
          {isSignedIn ? (
            <>
              <Link href="/pricing" className="btn btn-ghost">Plans</Link>
      ...
      <div id="site-mobile-menu" className={`mobile-menu${menuOpen ? " open" : ""}`}>
        ...
        <div className="mobile-menu-actions">
          {isSignedIn ? (
            <>
              <Link href="/pricing" className="btn btn-outline" onClick={() => setMenuOpen(false)}>Plans</Link>
              <Link href="/dashboard" className="btn btn-primary" onClick={() => setMenuOpen(false)}>Open dashboard</Link>
            </>
          ) : (
            <>
              <Link href="/sign-in" className="btn btn-outline" onClick={() => setMenuOpen(false)}>Sign in</Link>
              <Link href="/sign-up" className="btn btn-primary" onClick={() => setMenuOpen(false)}>Start free</Link>
            </>
          )}
        </div>
      </div>
        ...
        <div className="bento-grid">
          ...
          <div className="bento-card wide reveal">
            ...
            <div className="bento-visual" style={{ padding: "24px", display: "flex", alignItems: "flex-end", gap: "8px", height: "160px" }}>
              {[30, 45, 25, 60, 50, 80, 70, 95].map((height, index) => (
                <div key={index} style={{ flex: 1, background: index === 7 ? "var(--violet)" : "rgba(139, 92, 246, 0.2)", height: `${height}%`, borderRadius: "6px 6px 0 0" }} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="section-full-inner">
          ...
          <div className="steps-container">
            {[
              ...
              <div key={index} className="step-row reveal">
                <div className="step-number-large">{step.n}</div>
